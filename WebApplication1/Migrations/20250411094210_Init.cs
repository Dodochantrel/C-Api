        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeInterventionId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TechnicianInterventionsId = table.Column<int>(type: "integer", nullable: false),
                    TechniciansId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionTechnicians", x => new { x.TechnicianInterventionsId, x.TechniciansId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterventionTechnicians_Interventions_TechnicianInterventio~",
                        column: x => x.TechnicianInterventionsId,
